        ...
        return (
            <div className="flex flex-col h-full">
                ...
                <div className="space-y-8 flex-1 overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="border-b border-gray-100 pb-6">
                        <Skeleton className="h-5 w-24 mb-4" />
                        <div className="bg-slate-50 rounded-xl p-4 border border-slate-100 relative h-[200px]">
                            <div className="space-y-6 pl-7 relative before:content-[''] before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-slate-200">
                                {[1, 2, 3].map((i) => (
