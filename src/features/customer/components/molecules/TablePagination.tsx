...
export function TablePagination({
    ...
    const activeClasses = 'z-10 bg-brand-900 text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand-600';
